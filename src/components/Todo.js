...
import {useDeleteTodoMutation, useEditTodoMutation, useUpdateTodoColorMutation} from '../features/api/apiSlice';
import Error from './ui/Error';
export default function Todo ({todo}){

    const [deleteTodo, { isSuccess, isLoading, isError }] = useDeleteTodoMutation();
    ...
    return(
        <div className="flex justify-start items-center p-2 hover:bg-gray-100 hover:transition-all space-x-4 border-b border-gray-400/20 last:border-0">
            <div className={`relative rounded-full bg-white border-2 border-gray-400 w-5 h-5 flex flex-shrink-0 justify-center items-center mr-2 ${completed &&
